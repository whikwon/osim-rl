...
mot = mot[['Top.Head_tx', 'Top.Head_tz', 'L.Toe.Tip_tx', 'L.Toe.Tip_tz'
           'pelvis_tx', 'pelvis_tz', 'R.Toe.Tip_tx', 'R.Toe.Tip_tz']]

state_desc_compare += state_desc['body_pos']['head'].remove(1)
state_desc_compare += state_desc['body_pos']['toes_l'].remove(1)
state_desc_compare += state_desc['body_pos']['pelvis'].remove(1)
state_desc_compare += state_desc['body_pos']['pros_foot_r'].remove(1)
...
#        reward = 9.0 - (state_desc["body_vel"]["pelvis"][0] - 3.0)**2
        state_desc_compare = []
        state_desc_compare += state_desc['body_pos']['head'].remove(1)
        state_desc_compare += state_desc['body_pos']['toe_r'].remove(1)
        state_desc_compare += state_desc['body_pos']['pelvis'].remove(1)
        state_desc_compare += state_desc['body_pos']['pros_foot_r'].remove(1)

        reward += np.abs(np.array(state_desc_compare) -
                         mot.iloc[self.osim_model.istep].values)
        reward = 1 / reward
